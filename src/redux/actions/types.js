...
export const ACTIVATION_SUCCESS = 'ACTIVACION_SUCCESS';
export const ACTIVATION_FAIL = 'ACTIVACION_FAIL';
export const SET_AUTH_LOADING = 'SET_AUTH_LOADING';            //PARA HABILITAR ICONO DE CARGA 
...
export const SEARCH_PRODUCTS_SUCCCESS = 'SEARCH_PRODUCTS_SUCCCESS';
...
export const LOAD_BT_TOKEN_SUCCESS = 'LOAD_BD_TOKEN_SUCCESS';
export const LOAD_BT_TOKEN_FAIL = 'LOAD_BD_TOKEN_FAIL';
