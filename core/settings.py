...
'apps.cart','apps.shipping','apps.orders','apps.payment','apps.coupons','apps.wishlist','apps.reviews']
THIRD_PARTY_APPS=[
    'corsheaders',
    'rest_framework',
    'djoser',
...
DATABASES = {
        "default":env.db("DATABASE_URL",default="postgress:///ninerogues"),
}
DATABASES["default"]["ATOMIC_REQUESTS"]= True  #PARA EVITAR CUELLO DE BOTELLA, ACEPTA VARIOS REQUESTS

CORS_ORIGIN_WHITELIST =[             #QUE DOMINIOS PUEDEN A LOS A.P.I.
    'http://localhost:3000',
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'http://127.0.0.1:3000',
...
CSRF_TRUSTED_ORIGIN=[                #PERMISOS DE SEGURIDAD DE GOOGLE       
    'http://localhost:3000',
    'http://localhost:8000',
    'http://127.0.0.1:8000',
    'http://127.0.0.1:3000',
...
PASSWORD_HASHERS = [                 #PARA ASEGURAR LOS PASSWORD
...
SIMPLE_JWT = {                        #CONFIGURACIONES DE TOKEN DURACIONES,RENOVACIONES
