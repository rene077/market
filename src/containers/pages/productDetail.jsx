...
import WishlistHeart from "../../components/product/WishlistHeart";
  ...
  //LLEGAMOS AQUI(COMPONENT_PRODUCT-DETAIL) DESDE COMPONENT_SHOP desde donde muestra LOS PRODUCTS FILTRADO O NO
...
const ProductDetail =({
    ...
    const addToCart = async() => {
       if (product && product !== null && product !== undefined && product.quantify > 0) {
          setLoading(true)
    ...
    const remove = async() =>{
      remove_wishlist_item(product.id)
    ...
    useEffect(() => {                 //LAS FUNCTIONS QUE DEBEN ARRANCAR AL INICIO ANTES QUE TODO 
        window.scrollTo(0,0)
          ...
          <div className="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
            ...
            <div className="mt-6">
              <div>
                ...
                {/* ADD PARA VERIFICACION DE STOCK */}
              <p className="mt-4">
                  {
                    product &&
                    product !== null &&
              ...
              <div className="mt-4 flex sm:flex-col1">
                {loading? <button
                  onClick={addToCart}         /* NOS PERMITE ENVIAR EL STATE AL REDUX */
                  type="submit"
                ...
                {/* <button onClick={remove}>elimine</button> */}
